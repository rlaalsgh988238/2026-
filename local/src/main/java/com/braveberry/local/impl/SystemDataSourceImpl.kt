...
class SystemDataSourceImpl @Inject internal constructor(
    private val planBackUpDao: PlanBackUpDao,
    ...
    override suspend fun storePlanBackUp(backUp: String) {
        planBackUpDao.insert(BackUpLocalModel(jsonContent = backUp))
    }

    override suspend fun clearPlanBackUp() {
        planBackUpDao.clearAllBackUps()
    }

    override suspend fun loadPlanBackUp(): String? {
        return planBackUpDao.getBackUpById()
    }
}
