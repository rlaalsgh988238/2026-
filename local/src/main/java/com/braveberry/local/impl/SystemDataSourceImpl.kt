...
import com.braveberry.local.roomDB.dao.BackUpDao
...
class SystemDataSourceImpl @Inject internal constructor(
    ...
    override suspend fun storeBackUp(backUp: String) {
        backUpDao.insert(BackUpLocalModel(jsonContent = backUp))
    }
    ...
    override suspend fun loadBackUp(): String? {
        return backUpDao.getBackUpById()
    }
}
